...
Detect the mode from `the screenshots directory or web app URL the user provided (default: docs/screenshots/)`: a URL → web mode; a directory (or nothing → `docs/screenshots/`) → screenshot mode.
