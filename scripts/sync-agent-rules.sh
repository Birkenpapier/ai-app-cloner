...
#
# Agents with their own thin pointer files (hand-written, not generated):
...
description: Project conventions for the AI App Cloner template
alwaysApply: true
---"
